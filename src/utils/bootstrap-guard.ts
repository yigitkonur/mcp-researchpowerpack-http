...
export const BOOTSTRAP_MESSAGE = [
  ...
  '- `web-search` — fan out concept-group queries; returns tiered results with gaps and linked follow-ups',
  '- `search-reddit` — scoped Reddit search (only when the brief says `fire_reddit_branch: true`)',
